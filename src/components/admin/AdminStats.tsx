...
export default function AdminStats({
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
      <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-md p-3 sm:p-4">
      ...
      <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-md p-3 sm:p-4">
      ...
      <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-md p-3 sm:p-4">
      ...
      <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-md p-3 sm:p-4">
